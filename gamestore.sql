...
(
    ...
    FOREIGN KEY(teamName)
        REFERENCES team(name),
    CONSTRAINT own_any_game CHECK ( (nickname AS nick) IN ((SELECT OWN.nickname, OWN.title FROM rel_owns AS OWN WHERE OWN.nickname=nick) contains (SELECT gameTitle FROM rel_play AS PLAY WHERE PLAY.teamName=teamName)));
